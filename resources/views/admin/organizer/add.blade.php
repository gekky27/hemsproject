                ...
                <div class="flex-grow">
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                        <div class="p-6 border-b border-gray-200">
                            <h2 class="text-xl font-bold">Add New Organizer</h2>
                            <p class="text-gray-600">Create a new organizer account and profile</p>
                        </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="no_whatsapp" name="no_whatsapp" class="form-input"
                                            value="{{ old('no_whatsapp') }}" required placeholder="e.g., 628123456789">
                                        @error('no_whatsapp')
                                            <p class="input-error">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="organizer_name" name="organizer_name"
                                            class="form-input" value="{{ old('organizer_name') }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="organizer_type" name="organizer_type" class="form-input" required>
                                            ...
                                            <option value="Concerts"
                                                {{ old('organizer_type') == 'Concerts' ? 'selected' : '' }}>Concerts
                                            </option>
                                            <option value="Conference"
                                                {{ old('organizer_type') == 'Conference' ? 'selected' : '' }}>Conference
                                            </option>
                                            <option value="Workshop"
                                                {{ old('organizer_type') == 'Workshop' ? 'selected' : '' }}>Workshop
                                            </option>
                                            <option value="Theater"
                                                {{ old('organizer_type') == 'Theater' ? 'selected' : '' }}>Theater
                                            </option>
                                            <option value="All Type"
                                                {{ old('organizer_type') == 'All Type' ? 'selected' : '' }}>All Type
                                            </option>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="auditorium_type" name="auditorium_type" class="form-input" required>
                                            ...
                                            <option value="Melodia Pavilion"
                                                {{ old('auditorium_type') == 'Melodia Pavilion' ? 'selected' : '' }}>
                                                Melodia Pavilion</option>
                                            <option value="Garuda Theater"
                                                {{ old('auditorium_type') == 'Garuda Theater' ? 'selected' : '' }}>Garuda
                                                Theater
                                            </option>
                                            <option value="Celestia Theater"
                                                {{ old('auditorium_type') == 'Celestia Theater' ? 'selected' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <label for="logo" class="form-label">
                                            Organizer Logo <span class="required-mark">*</span>
                                        </label>
                                        <div class="file-input">
                                            <img src="https://placehold.co/500x500/444/fff?text=Logo" alt="Default Logo"
