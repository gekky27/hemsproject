                ...
                <div class="flex-grow">
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                        <div class="p-6 border-b border-gray-200 flex justify-between items-center">
                            <div>
                                <h2 class="text-xl font-bold">Venues</h2>
                                <p class="text-gray-600">Manage venues for events</p>
                            </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @forelse($venues as $venue)
                                            <tr class="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="text-sm text-gray-900">{{ $venue->alamat }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <div class="text-sm text-gray-900">
                                                        {{ number_format($venue->total_capacity) }}</div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                                    <span
                                                        class="status-badge {{ $venue->status === 'active' ? 'status-active' : 'status-inactive' }}">
                                    ...
                                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                                        ...
                                        <div>
                                            <span class="relative z-0 inline-flex shadow-sm rounded-md">
                                                ...
                                                @else
                                                    <a href="{{ $venues->previousPageUrl() }}" rel="prev"
                                                ...
                                                @if ($venues->hasMorePages())
                                                    <a href="{{ $venues->nextPageUrl() }}" rel="next"
    ...
    <div id="deleteModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center">
        <div class="bg-white rounded-lg max-w-md w-full p-6">
            <div class="text-center mb-4">
                ...
                <p class="text-gray-600 mt-2">Are you sure you want to delete <span id="venueName"
...
@push('scripts')
    <script>
        function confirmDelete(id, name) {
            ...
            document.getElementById('deleteForm').action = "{{ route('venues.delete', '') }}/" + id;
