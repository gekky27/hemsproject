                ...
                <div class="flex-grow">
                    <div class="bg-white rounded-lg shadow-sm overflow-hidden mb-6">
                        <div class="p-6 border-b border-gray-200">
                            <h2 class="text-xl font-bold">Edit Venue</h2>
                            <p class="text-gray-600">Update venue information</p>
                        </div>
                            ...
                            <form action="{{ route('venues.update', $venue->id) }}" method="POST">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="total_capacity" name="total_capacity" class="form-input"
                                            value="{{ old('total_capacity', $venue->total_capacity) }}" min="1"
                                            required>
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <input type="text" id="address" name="address" class="form-input"
                                        value="{{ old('address', $venue->alamat) }}" required>
                                    @error('address')
                                        <p class="input-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <textarea id="description" name="description" rows="4" class="form-input" required>{{ old('description', $venue->description) }}</textarea>
                                    @error('description')
                                        <p class="input-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <select id="status" name="status" class="form-input" required>
                                        <option value="active"
                                            {{ old('status', $venue->status) == 'active' ? 'selected' : '' }}>Active
                                        </option>
                                        <option value="inactive"
                                            {{ old('status', $venue->status) == 'inactive' ? 'selected' : '' }}>Inactive
                                        </option>
                                    </select>
                                    @error('status')
                                        <p class="input-error">{{ $message }}</p>
